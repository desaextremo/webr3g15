...
*/
  peticion.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      let exensionModif = respuesta.extension;
      let categoryIdModif = respuesta.category_id;
      ...
      document.getElementById("idLabel").innerHTML =
        "<strong>Farm id :</strong>" + idModif;

      nuevo.style.display = "none";
      modificar.style.display = "block";
      borrar.style.display = "none";
      datos.style.display = "none";
      document.getElementById("addressModif").focus()
    }
  };
  ...
  peticion.onreadystatechange = function () {
    if (this.readyState == 4 && this.status == 200) {
      ...
      document.getElementById("addressList").innerHTML =
        "<strong>Address :</strong>" + addressModif;
      document.getElementById("exensionList").innerHTML =
        "<strong>Exension :</strong>" + exensionModif;
      document.getElementById("category_idList").innerHTML =
        "<strong>Farm categoryId :</strong>" + categoryIdModif;
      document.getElementById("nameList").innerHTML =
        "<strong>Farm Name :</strong>" + nameModif;
