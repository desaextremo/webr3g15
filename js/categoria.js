let url ="http://129.146.8.100:8082/api/Category/all";
...
function editar(id) {
  ...
  url ="http://129.146.8.100:8082/api/Category";
...
function guardarNuevo() {
  ...
  url = "http://129.146.8.100:8082/api/Category/save";         
...
function guardarEditar() {
  ...
  //convierto el objeto de javascript a formato json
  let objetoJson = JSON.stringify(objeto)
  url ="129.146.8.100:8082/api/Category/update";
...
function guardarBorrar() {
  ...
  */
  ...
  let url = "129.146.8.100:8082/api/Category/delete";
