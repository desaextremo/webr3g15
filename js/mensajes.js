...
let url="http://129.146.8.100:8082/api/Message/all"
...
function editar(id) {
    ...
    url = "http://129.146.8.100:8082/api/Message"
...
function eliminar(id) {
    let url = "http://129.146.8.100:8082/api/Message"
...
function guardarNuevo() {
    ...
    url = "http://129.146.8.100:8082/api/Message/save";
...
function guardarBorrar() {
    let url = "http://129.146.8.100:8082/api/Message/delete"
...
function traerdatos() {
    let registros = ""
    let id = ""
    url="http://129.146.8.100:8082/api/Message/all"
...
function traefincas(){
    //1 crear un objeto XMLHttpRequest
    let peticion = new XMLHttpRequest();
    url = "http://129.146.8.100:8082/api/Farm/all";
    let id;
    let nombre;
    let respuesta;
    /*2 propiedad onreadystatechange asigna a una funcion
...
function traeclientes(){
    //1 crear un objeto XMLHttpRequest
    let peticion = new XMLHttpRequest();
    url = "http://129.146.8.100:8082/api/Client/all";
    let id;
    let nombre;
    let respuesta;
    /*2 propiedad onreadystatechange asigna a una funcion
