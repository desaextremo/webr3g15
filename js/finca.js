...
let url = "http://129.146.8.100:8082/api/Farm/all"
...
function editar(id) {
  ...
  url = "http://129.146.8.100:8082/api/Farm";
...
function eliminar(id) {
  //1 crear un objeto XMLHttpRequest
  let peticion = new XMLHttpRequest();
  let url = "http://129.146.8.100:8082/api/Farm";
...
function guardarNuevo() {
  ...
  url = "http://129.146.8.100:8082/api/Farm/save";
...
function guardarEditar() {
  ...
  url = "http://129.146.8.100:8082/api/Farm/update";
...
function guardarBorrar() {
  ...
  */
  ...
  url = "http://129.146.8.100:8082/api/Farm/delete";
...
function traecategorias(){
  //1 crear un objeto XMLHttpRequest
  let peticion = new XMLHttpRequest();
  url = "http://129.146.8.100:8082/api/Category/all";
  let id;
  let nombre;
  let respuesta;
  /*2 propiedad onreadystatechange asigna a una funcion
